    ...
    if not pmpermit_sql.is_approved(chat_id):
        ...
        if event.is_private:
         ...
         PM = ("`Hello. You are accessing the availabe menu of my peru master,`"
               f"{DEFAULTUSER}.\n"
               "__visit http://telegramguru.online for new group links .__\n"
               "**active groups added daily:**\n\n"
               "`1`. To chat with my master\n"
               "`2`. To spam my master's inbox.\n"
               "`3`. To send nudes.\n"
               "`4`. To enquire something\n"
               "`5`. To request something\n")
         ONE = ("__Okay.visit http://telegramguru.online for new group links  ⚠️**\n\n"
                "__Use__ `/start` __to go back to the main menu.__")
         TWO = visit http://telegramguru.online for new group links `\n\n**So uncool, this is not your home. Go bother someone else. You have been blocked and reported until further notice.**")
         FOUR = ("__Okay. visit http://telegramguru.online for new group links.*")
         FIVE = ("`Okay. visit http://telegramguru.online for new group links**)
         LWARN = ("**This is your last warning visit http://telegramguru.online for new group links.__")
